	...
	$.fn.richText = function( options ) {
		...
		var settings = $.extend({
			...
			translations: {
				...
				'green': 'Verde',
				'purple': 'Púrpura',
				'darkTurquois': 'Turquesa Oscura',
				'turquois': 'Turquesa',
				'darkOrange': 'Naranja Oscura',
				'orange': 'Naranja',
				'yellow': 'Amarrillo',
				'imageURL': 'Image URL',
				'fileURL': 'File URL',
				...
				'justify': 'Justificar',
				'addOrderedList': 'Añadir lista ordenada',
				'addUnorderedList': 'Añadir lista sin ordenar',
				'addHeading': 'Añadir Cabecera/Título',
				'addFont': 'Añadir fuente',
				'addFontColor': 'Añadir color a la fuente',
				'addFontSize' : 'Añadir tamaño al a fuente',
				'addImage': 'Añadir iamgen',
